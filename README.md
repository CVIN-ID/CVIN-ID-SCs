...
amazing now can you export to a single .md file so i can it to the repo
...
Here is the content for the README file, saved as `README.md`:
...
CVIN-ID-SCs/ ├── ERC721/ │ ├── contracts/ │ ├── scripts/ │ └── test/ ├── ERC725/ │ ├── contracts/ │ ├── scripts/ │ └── test/ ├── ERC725XY/ │ ├── contracts/ │ ├── scripts/ │ └── test/ └── README.md
